<template>
  <v-card>
    <v-card-media src="/src/static/nature/n3.jpeg" :height="imageHeight" class="white--text">
    ...
    <v-card-text>
      <div class="post--item">
        ...
        <div class="post--action align-center justify-space-between mt-2">
          <div class="social">
            <a class="grey--text" @click="handleThumb">
              <v-icon small>thumb_up</v-icon>
              <small>100+</small>
            </a>
            <a class="grey--text mx-3" @click="handleComment">
              <v-icon small>mode_comment</v-icon>
              <small>12+</small>
            </a>
            <a class="grey--text " @click="handleFavorite">
