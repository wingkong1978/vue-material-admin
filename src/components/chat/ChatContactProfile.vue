<template>
  <v-container id="profile" fluid fill-height class="pa-0 ma-0 white">
    <v-layout column class="pa-0 ma-0">
      <v-card class="elevation-0">
        <v-card-media height="380" src="/src/static/bg/4.jpg">
                    ...
                    <v-list two-line class="pa-0">
                      ...
                      <v-list-tile href="#">
                        ...
                        <v-list-tile-content>
                          ...
                          <v-list-tile-sub-title>{{ user.address.city }}, {{ user.address.state }} {{ user.address.zipcode }}</v-list-tile-sub-title>
                        </v-list-tile-content>
                      </v-list-tile>
                    </v-list>
                  </v-card-text>
