    ...
    <v-container grid-list-xl fluid>
      <v-layout row wrap>
        <v-flex lg4>
          <v-widget title="Default">
            <div slot="widget-content">
              <v-list>
                <v-list-tile v-for="item in users" :key="item.title" avatar @click="handleClick">
                  <v-list-tile-action>
          ...
          <v-widget title="Two line" class="mt-3">
            <div slot="widget-content">
              <v-list two-line subheader>
                ...
                <v-list-tile v-for="item in folders" :key="item.title" avatar @click="handleClick">
                  <v-list-tile-avatar>
            ...
            <div slot="widget-content">
              <v-list three-line>
                <template v-for="(item, index) in chats">
                  ...
                  <v-list-tile v-else :key="item.title" avatar href="#">
                    <v-list-tile-avatar>
                      <img :src="item.avatar">
                    </v-list-tile-avatar>
                    <v-list-tile-content>
        ...
        <v-flex lg4>
          ...
          <v-widget title="Long dark list with scroll" class="mt-3">
            <div slot="widget-content" style="max-height: 250px; overflow-y: scroll">
              <v-list dense dark>
                <v-list-tile v-for="item in allUsers" :key="item.title" avatar @click="handleClick">
                  <v-list-tile-action>
                    <v-icon color="pink">star</v-icon>
                  </v-list-tile-action>
                  <v-list-tile-content>
        ...
        <v-flex lg4>
          ...
          <v-card class="mt-3">
            <v-card-media src="/src/static/bg/15.jpg" height="300px">
