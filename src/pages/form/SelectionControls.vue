            ...
            <div slot="widget-content">
              ...
              <div class="text-mixed  mt-3">
                ...
                <v-layout align-center class="ma-0">
                  <v-checkbox v-model="includeFiles" hide-details class="shrink mr-2" />
                  <v-text-field label="Include files" />
                </v-layout>
                <v-layout align-center class="ma-0">
                  <v-checkbox v-model="enabled" hide-details class="shrink mr-2" />
                  <v-text-field label="I only work if you check the box" :disabled="!enabled" />
                </v-layout>
              </div>
            </div>
          </v-widget>
            ...
            <div slot="widget-content">
              <div class="basic">
                ...
                <v-radio-group v-model="radio1" :mandatory="false">
                  <v-radio label="Primary" color="primary" value="radio-1" />
                  <v-radio label="Success" color="success" value="radio-2" />
                  <v-radio label="Info" color="info" value="radio-3" />
                </v-radio-group>
              </div>
              <div class="basic">
                <v-subheader class="pa-0">Horizontal </v-subheader>
                <v-radio-group v-model="radio2" :mandatory="false" row>
                  <v-radio label="Radio 1" value="radio-1" color="pink" />
                  <v-radio label="Radio 2" value="radio-2" color="secondary" />
                  <v-radio label="Radio 3" value="radio-3" color="teal" />
                </v-radio-group>
              </div>
            </div>
          </v-widget>
          <v-widget title="Switches" class="mt-3">
            <div slot="widget-content">
              <div class="basic">
                ...
                <v-switch v-model="s1" :label="s1 ? 'On': 'Off'" />
              </div>
              <div class="basic">
                <v-subheader class="pa-0">Custom text value:  {{ s2 }} </v-subheader>
                <v-switch v-model="s2" value="Yes" :label="s2 ? 'Yes': 'No'" color="success" />
              </div>
            </div>
          </v-widget>
        </v-flex>
