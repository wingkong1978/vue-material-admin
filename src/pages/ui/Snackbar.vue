            ...
            <section slot="widget-content">
              <v-container fluid>
                <v-layout row wrap>
                  ...
                  <v-flex xs12 sm3>
                    <v-checkbox v-model="x" value="left" label="Left" />
                  </v-flex>
                  <v-flex xs6 sm3>
                    <v-checkbox v-model="x" value="right" label="Right" />
                  </v-flex>
                  <v-flex xs6 sm3>
                    <v-checkbox v-model="y" value="top" label="Top" />
                  </v-flex>
                  <v-flex xs6 sm3>
                    <v-checkbox v-model="y" value="bottom" label="Bottom" />
                  </v-flex>
                  <v-flex xs12 sm3>
                    <v-checkbox v-model="mode" value="multi-line" label="Multi-line (mobile)" />
                  </v-flex>
                  <v-flex xs12 sm3>
                    <v-checkbox v-model="mode" value="vertical" label="Vertical (mobile)" />
                  </v-flex>
                  <v-flex xs12 sm4>
