      ...
      <v-layout row wrap>
        <v-flex lg6 sm12>
          ...
          <v-widget title="Full Width" class="mt-3">
            <div slot="widget-content">
              <v-date-picker v-model="picker" landscape full-width color="green lighten-1" />
              <v-date-picker v-model="picker" full-width color="primary lighten-1" class="mt-3" />
            </div>
          </v-widget>
        </v-flex>
        <v-flex lg6 sm12>
          <v-widget title="Month Picker">
            <div slot="widget-content">
              <div class="flexbox-centering">
                <v-date-picker v-model="picker" type="month" color="teal lighten-1" />
              </div>
            </div>
          </v-widget>
